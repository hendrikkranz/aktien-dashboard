...
# Dezente visuelle Hierarchie für den Such-/Filterbereich.
st.markdown(
    """
    <style>
    /* Beschriftungen der Scout-Eingabefelder */
    ...
    /* Inhalt der Selectboxen, z. B. "Alle" */
    div[data-testid="stSelectbox"] div[data-baseweb="select"] > div {
        font-size: 0.84rem !important;
    }

    /* Dezente helle Kontur der Eingabefelder */
    div[data-testid="stSelectbox"] div[data-baseweb="select"] > div,
    div[data-testid="stTextInput"] div[data-baseweb="input"] {
        border: 1px solid rgba(255, 255, 255, 0.16) !important;
    }

    /* Etwas mehr Abstand zwischen den Filterzeilen */
